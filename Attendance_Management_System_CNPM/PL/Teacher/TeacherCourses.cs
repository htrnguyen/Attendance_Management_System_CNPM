...
namespace Attendance_Management_System_CNPM.PL.Teacher
{
    public partial class TeacherCourses : Form
    {
        ...
        private int UserID;
        private int termID;
        public TeacherCourses(MainDashboard mainDashboard, int userID, int termID)
        {
            InitializeComponent();
        ...
        {
            var courses = teacherBLL.GetCourses(UserID, termID);
        ...
        private void CoursePanel_Click(object sender, EventArgs e)
        {
            ...
            TeacherWeeks teacherWeeks = new TeacherWeeks(mainDashboard, UserID, course);
            mainDashboard.ShowForm(teacherWeeks);
        }
